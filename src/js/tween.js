    ...
    var Easing = {
        ...
        Back: {
            ...
            InOut: function (amount) {
                ...
                return (
                    0.5 * ((amount -= 2) * amount * ((s + 1) * amount + s) + 2)
                );
            },
        },
        Bounce: {
            ...
            Out: function (amount) {
                if (amount < 1 / 2.75) {
                    ...
                    return (
                        7.5625 * (amount -= 2.625 / 2.75) * amount + 0.984375
                    );
                }
            },
            InOut: function (amount) {
        ...
        CatmullRom: function (v, k) {
            ...
            if (v[0] === v[m]) {
                ...
                if (k > 1) {
                    return (
                        v[m] -
                        (fn(v[m], v[m], v[m - 1], v[m - 1], f - m) - v[m])
                    );
                }
                return fn(
                    v[i ? i - 1 : 0],
        ...
        Tween.prototype.start = function (time) {
            ...
            if (this._reversed) {
                ...
                for (var property in this._valuesStartRepeat) {
                    ...
                    this._valuesStart[property] = this._valuesStartRepeat[
                        property
                    ];
                }
            }
            ...
            if (elapsed === 1) {
                if (this._repeat > 0) {
                    ...
                    for (property in this._valuesStartRepeat) {
                        if (
                            !this._yoyo &&
                            typeof this._valuesEnd[property] === "string"
                        ) {
                    ...
                    for (
                        var i = 0,
                            numChainedTweens = this._chainedTweens.length;
                        i < numChainedTweens;
                        i++
                    ) {
